...
def avg_data_2013():
    temp_i=0
    average=[]
    for rows in pd.read_csv('Data/AQI/aqi2013.csv',chunksize=24):       #chunksize indicates how many records we are going to take
        add_var=0
        avg=0.0
        data=[]
...
if __name__=="__main__":
    ...
    plt.plot(range(0,365),lst2015,label="2017 data")
